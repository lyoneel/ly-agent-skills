...
Part of my collection of skills, created with [Crush](https://github.com/charmbracelet/crush) using different model families (Qwen, DeepSeek), targeting locally hosted models such as Qwen 27B and other mid-sized models.
